...
import DirectResetPassword from './Navbar/DirectResetPassword';
import VerifyOTP from './Navbar/VerifyOTP;';
        ...
        <HelmetProvider>
            ...
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/reset-password-direct" element={<DirectResetPassword />} />
                </Routes>
                <ChatBotComponent/>
            </BrowserRouter>
        </HelmetProvider>
