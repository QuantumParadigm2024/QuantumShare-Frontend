    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.post(
                `/quantum-share/user/direct/password/reset`,
                params
            );
        ...
        <>
            ...
            >
                ...
                <Box>
                    ...
                    >
                        Your session has expired. Please set a new password for <strong>{email}</strong>
                    </Typography>
                    <Box component="form" noValidate sx={{ mt: 2 }}>
                        <Grid container spacing={2} justifyContent="center">
                            ...
                            <Grid item xs={12}>
                                ...
                                >
                                    {loading ? <TailSpin color="#ba343b" height={25} width={25} /> : 'Reset Password'}
                                </Button>
                            </Grid>
                        </Grid>
                    </Box>
