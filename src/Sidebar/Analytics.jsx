...
const Analytics = () => {
    ...
    const getPlatformIcon = (platformName) => {
        switch (platformName.toLowerCase()) {
            ...
            case 'linkedin':
                return <ReactSVG src={linkedInIcon} alt="Linkedin" />;
            default:
                return null;
        }
    };
                        ...
                        {selectedPost && selectedPost.platform && (
                            <>
                                ...
                                {selectedPost.platform === 'linkedin' && (
                                    <ReactSVG src={linkedInIcon} alt="Linkedin" style={iconStyle} />
                                )}
                            </>
                        )}
                    </DialogTitle>
                                        ...
                                        <div style={{
                                            ...
                                            {selectedPost.data.commentCount !== undefined && (
                                                <div style={{ marginBottom: '5px' }}>
                                                    ...
                                                    >
                                                        <CommentOutlinedIcon
                                                            sx={{ color: 'grey', fontSize: '20px', marginRight: '8px' }}
                                                        />
                                                        <span style={{ fontWeight: '600', color: '#333', marginRight: '10px' }}>
                                                            Comments : {selectedPost.data.commentCount}
                                                        </span>

                                                        {Array.isArray(selectedPost.data.commentData) &&
                                                            selectedPost.data.commentData.length > 0 && (
                                                                <Button
                                                                    size="small"
                                                                    variant="text"
                                                                    onClick={handleOpen}
                                            ...
                                            {/* Dialog / Popup */}
                                            <Dialog open={openComments} onClose={handleClose} maxWidth="sm" fullWidth>
                                                ...
                                                <DialogContent dividers>
                                                    {Array.isArray(selectedPost.data.commentData) &&
                                                        selectedPost.data.commentData.length > 0 ? (
                                                        selectedPost.data.commentData.map((comment, index) => (
                                                            <div
                                                                key={comment.id || index}
                                                                style={{
                                                                    borderBottom:
                                                                        index !== selectedPost.data.commentData.length - 1
                                                                            ? '1px solid #eee'
                                                                            : 'none',
                                                                    paddingBottom: '6px',
                                                                    marginBottom: '6px',
                                                            ...
                                                            >
                                                                <p style={{ margin: 0, fontWeight: '600', color: '#444', fontSize: '14px' }}>
                                                                ...
                                                                <p style={{ margin: 0, fontSize: '11px', color: '#999' }}>
                                                                    {new Date(comment.time || comment.timestamp).toLocaleString()}
                                                                </p>
                                                            </div>
                                                        ))
                                                    ) : (
